    ...
    where SELF : Length<C, T, SELF>
{
    ...
    public SELF Add<RIGHT_C, RIGHT_T, RIGHT_SELF>(Length<RIGHT_C, RIGHT_T, RIGHT_SELF> right)
    ...
    public SELF Subtract<RIGHT_C, RIGHT_T, RIGHT_SELF>(Length<RIGHT_C, RIGHT_T, RIGHT_SELF> right)
        where RIGHT_C : Coordinate<Dimension.Length>
        where RIGHT_T : INumber<RIGHT_T>
        where RIGHT_SELF : Length<RIGHT_C, RIGHT_T, RIGHT_SELF> =>
        Reconstruct(Value - ConvertToLeft(right));

    private static T ConvertToLeft<RIGHT_C, RIGHT_T, RIGHT_SELF>(Length<RIGHT_C, RIGHT_T, RIGHT_SELF> right)
        where RIGHT_C : Coordinate<Dimension.Length>
        where RIGHT_T : INumber<RIGHT_T>
        where RIGHT_SELF : Length<RIGHT_C, RIGHT_T, RIGHT_SELF>
    {
...
{
    extension<LEFT_C, LEFT_T, LEFT_SELF, RIGHT_C, RIGHT_T, RIGHT_SELF>(Length<LEFT_C, LEFT_T, LEFT_SELF>)
        ...
        where RIGHT_SELF : Length<RIGHT_C, RIGHT_T, RIGHT_SELF>
    {
        public static LEFT_SELF operator +(Length<LEFT_C, LEFT_T, LEFT_SELF> left, Length<RIGHT_C, RIGHT_T, RIGHT_SELF> right) => left.Add(right);
        public static LEFT_SELF operator -(Length<LEFT_C, LEFT_T, LEFT_SELF> left, Length<RIGHT_C, RIGHT_T, RIGHT_SELF> right) => left.Subtract(right);
    }
}

public static class LengthProductOperators
{
    extension<LEFT_C, RIGHT_C, T, LEFT_SELF, RIGHT_SELF>(Length<LEFT_C, T, LEFT_SELF>)
        where LEFT_C : Coordinate<Dimension.Length>
        where RIGHT_C : Coordinate<Dimension.Length>
        where T : INumber<T>
