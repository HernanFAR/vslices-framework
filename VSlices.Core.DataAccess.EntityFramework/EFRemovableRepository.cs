...
/// <summary>
/// Defines a repository that can remove <see cref="TEntity"/> entities using EntityFramework Core
/// </summary>
...
/// <summary>
/// Defines a repository that can remove <see cref="TDbContext"/> with <see cref="TEntity"/> input, using EntityFramework Core, useful to use DDD with database-first scenarios
/// </summary>
/// <typeparam name="TDbContext">The <see cref="DbContext"/> related to the use case</typeparam>
