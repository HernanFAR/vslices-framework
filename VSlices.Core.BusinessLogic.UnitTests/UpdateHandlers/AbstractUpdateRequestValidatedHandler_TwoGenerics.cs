...
public class AbstractUpdateRequestValidatedHandler_TwoGenerics
{
    public record Domain;
    public record Request;

    private readonly Mock<IUpdateableRepository<Domain>> _mockedRepository;
    private readonly Mock<AbstractUpdateRequestValidatedHandler<Request, Domain>> _mockedHandler;

    public AbstractUpdateRequestValidatedHandler_TwoGenerics()
    {
        _mockedRepository = new Mock<IUpdateableRepository<Domain>>();
        _mockedHandler = new Mock<AbstractUpdateRequestValidatedHandler<Request, Domain>>(_mockedRepository.Object);
    }
