...
public class AbstractUpdateDomainValidatedHandler_ThreeGenerics
{
    ...
    private readonly Mock<AbstractUpdateDomainValidatedHandler<Request, Response, Domain>> _mockedHandler;

    public AbstractUpdateDomainValidatedHandler_ThreeGenerics()
    {
        _mockedRepository = new Mock<IUpdateableRepository<Domain>>();
        _mockedHandler = new Mock<AbstractUpdateDomainValidatedHandler<Request, Response, Domain>>(_mockedRepository.Object);
    }
