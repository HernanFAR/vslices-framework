...
public class AbstractUpdateDomainValidatedHandler_TwoGenerics
{
    public record Domain;
    public record Request;

    private readonly Mock<IUpdateableRepository<Domain>> _mockedRepository;
    private readonly Mock<AbstractUpdateDomainValidatedHandler<Request, Domain>> _mockedHandler;

    public AbstractUpdateDomainValidatedHandler_TwoGenerics()
    {
        _mockedRepository = new Mock<IUpdateableRepository<Domain>>();
        _mockedHandler = new Mock<AbstractUpdateDomainValidatedHandler<Request, Domain>>(_mockedRepository.Object);
    }
