...
public class DomainValidatedRemoveHandler_ThreeGenerics
{
    ...
    private readonly Mock<DomainValidatedRemoveHandler<Request, Response, Domain>> _mockedHandler;

    public DomainValidatedRemoveHandler_ThreeGenerics()
    {
        _mockedRepository = new Mock<IRemovableRepository<Domain>>();
        _mockedHandler = new Mock<DomainValidatedRemoveHandler<Request, Response, Domain>>(_mockedRepository.Object);
    }
