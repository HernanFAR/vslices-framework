...
public class AbstractRemoveFullyValidatedHandler_TwoGenerics
{
    public record Domain;
    public record Request;

    private readonly Mock<IRemovableRepository<Domain>> _mockedRepository;
    private readonly Mock<AbstractRemoveFullyValidatedHandler<Request, Domain>> _mockedHandler;

    public AbstractRemoveFullyValidatedHandler_TwoGenerics()
    {
        _mockedRepository = new Mock<IRemovableRepository<Domain>>();
        _mockedHandler = new Mock<AbstractRemoveFullyValidatedHandler<Request, Domain>>(_mockedRepository.Object);
    }
