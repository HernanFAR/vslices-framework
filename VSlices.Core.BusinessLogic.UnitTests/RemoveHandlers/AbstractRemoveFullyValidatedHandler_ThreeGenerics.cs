...
public class AbstractRemoveFullyValidatedHandler_ThreeGenerics
{
    ...
    private readonly Mock<AbstractRemoveFullyValidatedHandler<Request, Response, Domain>> _mockedHandler;

    public AbstractRemoveFullyValidatedHandler_ThreeGenerics()
    {
        _mockedRepository = new Mock<IRemovableRepository<Domain>>();
        _mockedHandler = new Mock<AbstractRemoveFullyValidatedHandler<Request, Response, Domain>>(_mockedRepository.Object);
    }
