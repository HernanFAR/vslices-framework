...
public class AbstractRemoveDomainValidatedHandler_ThreeGenerics
{
    ...
    private readonly Mock<AbstractRemoveDomainValidatedHandler<Request, Response, Domain>> _mockedHandler;

    public AbstractRemoveDomainValidatedHandler_ThreeGenerics()
    {
        _mockedRepository = new Mock<IRemovableRepository<Domain>>();
        _mockedHandler = new Mock<AbstractRemoveDomainValidatedHandler<Request, Response, Domain>>(_mockedRepository.Object);
    }
