...
public class AbstractRemoveDomainValidatedHandler_TwoGenerics
{
    public record Domain;
    public record Request;

    private readonly Mock<IRemovableRepository<Domain>> _mockedRepository;
    private readonly Mock<AbstractRemoveDomainValidatedHandler<Request, Domain>> _mockedHandler;

    public AbstractRemoveDomainValidatedHandler_TwoGenerics()
    {
        _mockedRepository = new Mock<IRemovableRepository<Domain>>();
        _mockedHandler = new Mock<AbstractRemoveDomainValidatedHandler<Request, Domain>>(_mockedRepository.Object);
    }
