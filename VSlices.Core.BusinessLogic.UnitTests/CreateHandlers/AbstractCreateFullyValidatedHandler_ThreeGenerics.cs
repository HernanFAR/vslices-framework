...
public class AbstractCreateFullyValidatedHandler_ThreeGenerics
{
    ...
    private readonly Mock<AbstractCreateFullyValidatedHandler<Request, Response, Domain>> _mockedHandler;

    public AbstractCreateFullyValidatedHandler_ThreeGenerics()
    {
        _mockedRepository = new Mock<ICreatableRepository<Domain>>();
        _mockedHandler = new Mock<AbstractCreateFullyValidatedHandler<Request, Response, Domain>>(_mockedRepository.Object);
    }
    ...
    [Fact]
    public async Task HandleAsync_ShouldReturnBusinessFailure_DetailCallValidateRequestAsyncAndValidateUseCaseRulesAsyncAndGetDomainEntityAsyncAndValidateDomainAsyncAndCreateAsync()
    {
        var request = new Request();
        var domain = new Domain();
