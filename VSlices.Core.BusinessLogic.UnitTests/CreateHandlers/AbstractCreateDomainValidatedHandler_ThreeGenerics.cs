...
public class AbstractCreateDomainValidatedHandler_ThreeGenerics
{
    ...
    private readonly Mock<AbstractCreateDomainValidatedHandler<Request, Response, Domain>> _mockedHandler;

    public AbstractCreateDomainValidatedHandler_ThreeGenerics()
    {
        _mockedRepository = new Mock<ICreatableRepository<Domain>>();
        _mockedHandler = new Mock<AbstractCreateDomainValidatedHandler<Request, Response, Domain>>(_mockedRepository.Object);
    }
    ...
    [Fact]
    public async Task HandleAsync_ShouldReturnBusinessFailure_DetailCallValidateUseCaseRulesAsyncAndGetDomainEntityAsyncAndValidateDomainAsyncAndCreateAsync()
    {
        var request = new Request();
        var domain = new Domain();
