...
public class AbstractCreateHandler_ThreeGenerics
{
    ...
    private readonly Mock<AbstractCreateHandler<Request, Response, Domain>> _mockedHandler;

    public AbstractCreateHandler_ThreeGenerics()
    {
        _mockedRepository = new Mock<ICreatableRepository<Domain>>();
        _mockedHandler = new Mock<AbstractCreateHandler<Request, Response, Domain>>(_mockedRepository.Object);
    }
