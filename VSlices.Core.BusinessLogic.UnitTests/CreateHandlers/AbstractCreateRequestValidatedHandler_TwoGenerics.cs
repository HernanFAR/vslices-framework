...
public class AbstractCreateRequestValidatedHandler_TwoGenerics
{
    public record Domain;
    public record Request;

    private readonly Mock<ICreatableRepository<Domain>> _mockedRepository;
    private readonly Mock<AbstractCreateRequestValidatedHandler<Request, Domain>> _mockedHandler;

    public AbstractCreateRequestValidatedHandler_TwoGenerics()
    {
        _mockedRepository = new Mock<ICreatableRepository<Domain>>();
        _mockedHandler = new Mock<AbstractCreateRequestValidatedHandler<Request, Domain>>(_mockedRepository.Object);
    }
