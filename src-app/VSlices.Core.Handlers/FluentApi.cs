...
/// <summary>
/// Start point of a FluentAPI that helps with the definition of simple <see cref="IHandler{TRequest,TResult}"/>
/// implementations
/// </summary>
public abstract class Handler
{
    ...
    public abstract partial class WithoutResult
    {
            ...
            where TFeature : IFeature<Success>
        {
            ...
            /// </summary>
            public abstract partial class ToCreate<TEntity> : CreateHandler<TFeature, TEntity>
            {
                /// <inheritdoc />
            ...
            /// </summary>
            public abstract partial class ToUpdate<TEntity> : UpdateHandler<TFeature, TEntity>
            {
                /// <inheritdoc />
            ...
            /// </summary>
            public abstract class ToDelete<TEntity> : DeleteHandler<TFeature, TEntity>
            {
                /// <inheritdoc />
    ...
    public abstract partial class WithResult<TResult>
    {
            ...
            where TFeature : IFeature<TResult>
        {
            ...
            /// Represents a handler for <typeparamref name="TFeature"/>, that creates <typeparamref name="TEntity"/>
            /// </summary>
            public abstract partial class ToCreate<TEntity> : CreateHandler<TFeature, TResult, TEntity>
            {
                /// <inheritdoc />
                protected ToCreate(ICreateRepository<TEntity> repository) : base(repository) { }
            ...
            /// Represents a handler for <typeparamref name="TFeature"/>, that updates <typeparamref name="TEntity"/>
            /// </summary>
            public abstract class ToUpdate<TEntity> : UpdateHandler<TFeature, TResult, TEntity>
            {
                /// <inheritdoc />
                protected ToUpdate(IUpdateRepository<TEntity> repository) : base(repository) { }
            ...
            /// Represents a handler for <typeparamref name="TFeature"/>, that removes <typeparamref name="TEntity"/>
            /// </summary>
            public abstract class ToDelete<TEntity> : DeleteHandler<TFeature, TResult, TEntity>
            {
                /// <inheritdoc />
                protected ToDelete(IRemoveRepository<TEntity> repository) : base(repository) { }
...
/// <summary>
/// Start point of a FluentAPI that helps with the definition of validated <see cref="IHandler{TRequest,TResult}"/>
/// implementations
/// </summary>
public abstract class ValidatedHandler
{
    /// <summary>
    /// Represents a handler for <see cref="IFeature{TResult}"/> that returns <see cref="Success"/>
    /// </summary>
